...
-- CreateEnum
CREATE TYPE "EntityType" AS ENUM ('COLLECTION', 'COLLECTION_ITEM', 'INSTITUTION', 'ACADEMIC_TERM', 'COURSE', 'STUDY_SESSION', 'NOTE', 'NOTE_BLOCK', 'RESOURCE', 'ASSET', 'ANNOTATION', 'SESSION_NOTE', 'SESSION_RESOURCE', 'AI_ARTIFACT');
...
-- CreateEnum
CREATE TYPE "AIJobType" AS ENUM ('SESSION_DIGEST', 'PDF_EXTRACTION');
