...
struct SourceDetailView: View {
    ...
    @State private var citationPageNumber: Int?
    ...
    init(
        ...
        _citationPageNumber = State(initialValue: initialPageNumber)
    }
        ...
        VStack(spacing: 0) {
            if isLoading {
                ...
                PDFDocumentView(
                    ...
                    highlightPageNumber: citationPageNumber
                )
    ...
    private func openCitation(
        ...
        citationPageNumber = reference.pageNumber
