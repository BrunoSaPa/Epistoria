...
- On-device formula recognition remains a development feature until a permissively licensed Core
  ...
  No production model is available yet. Early printed-equation tests found symbol and notation
  errors. Recognition quality and iPad integration still require validation before release.
